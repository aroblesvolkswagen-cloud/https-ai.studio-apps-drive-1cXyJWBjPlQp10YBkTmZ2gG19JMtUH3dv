...
const GaugeChart: React.FC<GaugeChartProps> = ({ value, label, max = 2 }) => {
  ...
  return (
    <div className="p-4 glass flex flex-col items-center justify-between h-full">
      <h3 className="font-semibold text-text-default mb-2 text-center">{label}</h3>
      <div className="relative w-64 h-32 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
          <div className="w-56 h-28 rounded-t-full" style={{ background: 'var(--glass-bg)' }}></div>
        </div>
        <div 
